...
{
public:
	btTransform mytransformation;
	
	/*  Functions   */
	// Constructor, expects a filepath to a 3D model.
	//Model(GLchar* path, btMatrix3x3 rotation, btVector3 translation)
	Model(GLchar* path)
	{
		this->loadModel(path);
	}

	btTransform Modeltransformation(btMatrix3x3 rotation, btVector3 translation)
	{
		this->mytransformation = btTransform(rotation, translation);
