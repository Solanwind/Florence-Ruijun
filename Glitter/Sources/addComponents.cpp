...
glm::mat4 AddComponents::renderSphere(btRigidBody* sphere)
{
...
void AddComponents::addGround() {
	...
	btRigidBody::btRigidBodyConstructionInfo groundbodyInfo(0, groundMotion, ground, btVector3(0, 0, 0));
	btRigidBody* groundbody = new btRigidBody(groundbodyInfo);
...
btDynamicsWorld* AddComponents::init()
{
	...
	myWorld = new btDiscreteDynamicsWorld(dispatcher, broadphase, solver, collisionConfig);
